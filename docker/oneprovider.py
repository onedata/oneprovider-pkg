...
if ONEPANEL_OVERRIDE:
    ...
    ONP_VM_ARGS_PATH = os.path.join(
        ONEPANEL_OVERRIDE, "_build/default/rel/op_panel/etc/autogenerated.vm.args"
    )
    ONP_GENERATED_CONFIG_PATH = os.path.join(
        ONEPANEL_OVERRIDE, "_build/default/rel/op_panel/etc/autogenerated.config"
    )
    ONP_RELEASES_PATH = os.path.join(
        ONEPANEL_OVERRIDE, "_build/default/rel/op_panel/releases/RELEASES"
    )
else:
    LEGACY_VM_ARGS_PATH_TEMPLATE = "/etc/{component}/vm.args"
    ONP_VM_ARGS_PATH = "/etc/op_panel/autogenerated.vm.args"
    ONP_GENERATED_CONFIG_PATH = "/etc/op_panel/autogenerated.config"
    ONP_RELEASES_PATH = "/usr/lib/op_panel/releases/RELEASES"
...
def start_onepanel_and_await_readiness() -> None:
    ...
    if ONEPANEL_OVERRIDE:
        op_panel_script = os.path.join(ONEPANEL_OVERRIDE, ONP_BIN_SOURCES_PATH)
