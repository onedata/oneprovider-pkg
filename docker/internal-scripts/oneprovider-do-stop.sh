...
### Oneprovider docker container and reports if there are any errors.
###-------------------------------------------------------------------
...
if [ $ERR_COUNTER -eq 0 ]; then
    ...
    dispatch-log "FAILURE! There have been errors when stopping the Oneprovider service (see above)."
