...
###-------------------------------------------------------------------
### Common constants and functions used in the Oneprovider container scripts.
###-------------------------------------------------------------------

# Presence of this file indicates that a graceful stop was already performed.
# It is deleted upon service start and created after the oneprovider-stop-graceful.sh succeeds.
GRACEFUL_STOP_LOCK_FILE='/root/graceful-stop.lock'
# A log file that includes a complete history of starts & stops or all oneprovider sub-services.
JOURNAL_LOG_FILE='/var/log/oneprovider/journal.log'
